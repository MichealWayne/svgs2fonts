...
export declare const DEFAULT_FONT_FORMATS: FontFormat[];
export declare const VALID_FONT_FORMATS: FontFormat[];
/**
 ...
 */
export declare function createConfiguration(options: Partial<EnhancedOptions>): ConfigurationManager;
