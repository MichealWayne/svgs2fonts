...
class DefaultProgressMonitor {
    ...
    recordMemoryUsage() {
        if (typeof process !== 'undefined' && process.memoryUsage) {
            ...
            this.memoryStats.peakMemoryUsage = Math.max(this.memoryStats.peakMemoryUsage, memUsage.heapUsed);
    ...
    generateReport() {
        ...
        const filesPerSecond = totalTimeSeconds > 0 ? this.fileStats.processedFiles / totalTimeSeconds : 0;
        const bytesPerSecond = totalTimeSeconds > 0 ? this.fileStats.totalOutputSize / totalTimeSeconds : 0;
