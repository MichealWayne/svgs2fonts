...
exports.LogLevel = exports.getIconStrUnicode = exports.isObject = exports.isNumber = exports.isString = exports.isSuccessResult = exports.debugLog = exports.warnLog = exports.errorLog = exports.log = void 0;
...
class Logger {
    ...
    formatMessage(level, message) {
        ...
        if (this.options.timestamp) {
            ...
            parts.push(this.options.colors ? `${Logger.COLORS.gray}${timestamp}${Logger.COLORS.reset}` : timestamp);
        }
...
class UnicodeGenerator {
    ...
    generateDeterministic(iconName) {
        ...
        let unicode = (hash % (this.options.maxUnicode - this.options.startUnicode)) + this.options.startUnicode;
    ...
    generateSequential() {
        ...
        if (unicode > this.options.maxUnicode) {
            throw new Error(`Unicode range exhausted. Cannot generate more than ${this.options.maxUnicode - this.options.startUnicode + 1} icons.`);
        }
        return unicode;
    }
    ...
    getStats() {
        const collisionRate = this.cache.size > 0 ? (this.usedCodes.size - this.cache.size) / this.cache.size : 0;
        return {
